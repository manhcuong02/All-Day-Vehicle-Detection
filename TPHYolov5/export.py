...
from TPHYolov5.models.common import Conv
from TPHYolov5.models.experimental import attempt_load
from TPHYolov5.models.yolo import Detect
from TPHYolov5.utils.activations import SiLU
from TPHYolov5.utils.datasets import LoadImages
from TPHYolov5.utils.general import (LOGGER, check_dataset, check_img_size, check_requirements, colorstr, file_size, print_args,
                           url2file)
...
def export_saved_model(model, im, file, dynamic,
    ...
    try:
        ...
        from TPHYolov5.models.tf import TFDetect, TFModel
...
def export_tflite(keras_model, im, file, int8, data, ncalib, prefix=colorstr('TensorFlow Lite:')):
    ...
    try:
        ...
        from TPHYolov5.models.tf import representative_dataset_gen
